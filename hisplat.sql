/*
 ...
 Source Schema         : hisplat

 Target Server Type    : MySQL
 Target Server Version : 80019
 File Encoding         : 65001

 Date: 06/06/2020 16:33:45
*/
...
CREATE TABLE `area`  (
  ...
  CONSTRAINT `FK_area_REFERENCE_area` FOREIGN KEY (`pid`) REFERENCES `area` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `data_dic`  (
  ...
  `d_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '含义名称',
  `d_value` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '含义值',
  `d_colum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '对应字段名称',
  `dis` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '描述名称',
...
CREATE TABLE `department`  (
  ...
  `d_num` int(0) DEFAULT NULL,
  `d_tel` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '科室电话',
  `d_level_id` int(0) DEFAULT NULL COMMENT '科室主任id',
  `h_id` int(0) DEFAULT NULL COMMENT '所属医院id',
  `parent_id` int(0) DEFAULT NULL,
  PRIMARY KEY (`d_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '科室表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of department
-- ----------------------------
INSERT INTO `department` VALUES (1, '内科', 10, '6666888', 10, 1, NULL);
INSERT INTO `department` VALUES (2, '儿科', 12, '534354', 2, 1, NULL);
INSERT INTO `department` VALUES (4, '住院部', 9, '6666654', 7, 1, 1);
INSERT INTO `department` VALUES (5, '外科', 4, '6666666', 11, 1, NULL);

-- ----------------------------
-- Table structure for h_in
-- ----------------------------
DROP TABLE IF EXISTS `h_in`;
CREATE TABLE `h_in`  (
  `in_id` int(0) NOT NULL AUTO_INCREMENT,
  `in_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `m_id` int(0) DEFAULT NULL,
  `in_state` int(0) DEFAULT NULL COMMENT '住院状态',
  `in_age` int(0) DEFAULT NULL,
  `in_phone` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `in_date` datetime(0) DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '住院日期',
  `bed_no` int(0) DEFAULT NULL COMMENT '病床号',
  `doc_id` int(0) DEFAULT NULL COMMENT '主治医生id',
  `nurse_id` int(0) DEFAULT NULL COMMENT '责任护士id',
  `pre_out_time` datetime(0) DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '预计出院日期',
  `out_time` datetime(0) DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '出院日期',
  ...
  `m_allergy_his` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '过敏史',
  `m_patient_condition` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '病情描述',
  `medication_info` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '用药详情',
  `mark` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '备注',
  `diagnostic_report_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '上传诊断报告',
  `in_sex` int(0) DEFAULT NULL COMMENT '性别 0.女，1.男',
  PRIMARY KEY (`in_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '住院管理' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of h_in
-- ----------------------------
INSERT INTO `h_in` VALUES (5, '小明', 6, 1, 16, '1211233213', '2020-05-28 10:57:07', 3024, 11, 8, '2020-05-28 10:57:07', '2020-05-28 10:57:07', '2020-05-28 10:57:07', '2020-05-28 10:57:07', '粉尘过敏', '感冒，咳嗽，流鼻涕', '扑尔敏，阿莫西林，头孢', '无', '/uploads/2020/05/26/df23a86b-eca1-4400-811c-1da1eedd4238.jpg', 0);
INSERT INTO `h_in` VALUES (6, '小明', 7, 1, 16, '1211233213', '2020-05-28 10:57:12', 3024, 11, 8, '2020-05-28 10:57:12', '2020-05-28 10:57:12', '2020-05-28 10:57:12', '2020-05-28 10:57:12', '粉尘过敏', '感冒，咳嗽，流鼻涕', '扑尔敏，阿莫西林，头孢', '无', '/uploads/2020/05/26/df23a86b-eca1-4400-811c-1da1eedd4238.jpg', 0);
INSERT INTO `h_in` VALUES (7, '小明', 8, 1, 16, '1211233213', '2020-05-28 10:57:18', 3024, 11, 8, '2020-05-28 10:57:18', '2020-05-28 10:57:18', '2020-05-28 10:57:18', '2020-05-28 10:57:18', '粉尘过敏', '感冒，咳嗽，流鼻涕', '扑尔敏，阿莫西林，头孢', '无', '/uploads/2020/05/26/df23a86b-eca1-4400-811c-1da1eedd4238.jpg', 0);
INSERT INTO `h_in` VALUES (8, '小李', 9, 1, 16, '1211233213', '2020-05-28 10:58:07', 3024, 11, 8, '2020-05-28 10:58:07', '2020-05-28 10:58:07', '2020-05-28 10:58:07', '2020-05-28 10:58:07', '粉尘过敏', '感冒，咳嗽，流鼻涕', '扑尔敏，阿莫西林，头孢', '无', '/uploads/2020/05/26/df23a86b-eca1-4400-811c-1da1eedd4238.jpg', 0);
INSERT INTO `h_in` VALUES (11, '小李', 7, 1, 16, '1211233213', '2020-05-28 09:00:00', 3024, 11, 8, '2020-05-28 09:00:00', '2020-05-29 10:10:00', '2020-05-28 11:26:55', '2020-05-28 11:26:55', '粉尘过敏', '感冒，咳嗽，流鼻涕', '扑尔敏，阿莫西林，头孢', '无', '/uploads/2020/05/26/df23a86b-eca1-4400-811c-1da1eedd4238.jpg', 0);

-- ----------------------------
-- Table structure for h_out
-- ----------------------------
DROP TABLE IF EXISTS `h_out`;
CREATE TABLE `h_out`  (
  `h_id` int(0) NOT NULL AUTO_INCREMENT,
  `h_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `h_sex` int(0) DEFAULT NULL,
  `h_age` int(0) DEFAULT NULL,
  `bed_no` int(0) DEFAULT NULL COMMENT '病床号',
  `doc_id` int(0) DEFAULT NULL COMMENT '主治医生id',
  `nurse_id` int(0) DEFAULT NULL COMMENT '护士id',
  `in_date` datetime(0) DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '入院时间',
  `d_id` int(0) DEFAULT NULL COMMENT '所属科室id',
  `h_check` int(0) DEFAULT NULL COMMENT '核准 0,未  1,已核准 ',
  `h_out_time` datetime(0) DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '出院时间',
  `h_diadnostic_symptom` varchar(0) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '诊断症状',
  `h_operation` varchar(0) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '手术',
  `h_condition` varchar(0) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '恢复情况',
  `h_mark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '备注',
...
CREATE TABLE `hospital`  (
  `h_id` int(0) NOT NULL AUTO_INCREMENT,
  `h_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `h_level_id` int(0) DEFAULT NULL COMMENT '医院级别id',
  `h_province_code` int(0) DEFAULT NULL,
  `h_city_code` int(0) DEFAULT NULL,
  `h_address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '医院地址',
  PRIMARY KEY (`h_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '医院表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of hospital
-- ----------------------------
INSERT INTO `hospital` VALUES (1, '郑州市第一人民医院', 1, 410000, 410100, '河南省郑州市金水区黄河路78号');

-- ----------------------------
-- Table structure for interrogation
-- ----------------------------
DROP TABLE IF EXISTS `interrogation`;
CREATE TABLE `interrogation`  (
  `in_id` int(0) NOT NULL,
  `in_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `in_sex` int(0) DEFAULT NULL,
  `in_problem` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '问题描述',
  `in_cardinal_symptom` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '主要症状',
  `in_medicine` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '所用药物',
  `in_need` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '你的需求',
  PRIMARY KEY (`in_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '在线问诊表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '医院级别表\r\r\n' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of level
-- ----------------------------
INSERT INTO `level` VALUES (1, '一级甲等');
...
CREATE TABLE `medical`  (
  ...
  `r_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '病例表id',
  `m_sex` int(0) DEFAULT NULL COMMENT '性别 0.女，1.男',
  `m_age` int(0) DEFAULT NULL,
  `m_date` date DEFAULT NULL COMMENT '就诊日期',
  `m_phone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `m_address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `d_id` int(0) DEFAULT NULL COMMENT '就诊科室',
  `m_allergy_his` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '过敏史',
  `m_patient_condition` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT '病情描述',
  `doc_id` int(0) DEFAULT NULL COMMENT '诊断医生id',
  `medication_info` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT '用药详情',
  `mark` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT '备注',
  `diagnostic_report_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '诊断报告文件地址',
  `m_type` int(0) DEFAULT NULL COMMENT '诊断类型，0检查/诊断，1治疗/手术，2复诊',
  `create_time` datetime(0) DEFAULT NULL,
  `update_time` datetime(0) DEFAULT NULL,
  PRIMARY KEY (`m_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '病例表\r\n\r\n' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of medical
-- ----------------------------
INSERT INTO `medical` VALUES (5, '小明', NULL, 0, 99, '2020-05-20', '1211233213', '郑州管城回族区', 1, '粉尘过敏', '感冒，咳嗽，流鼻涕', 11, '扑尔敏，阿莫西林，头孢', '无', '/uploads/2020/05/26/df23a86b-eca1-4400-811c-1da1eedd4238.jpg', 1, '2020-05-27 17:59:13', '2020-05-27 17:59:13');
INSERT INTO `medical` VALUES (6, '小明', 'e4058f645a324a37b6958a7cc4cb9ff4', 0, 16, '2020-05-20', '1211233213', '郑州管城回族区', 1, '粉尘过敏', '感冒，咳嗽，流鼻涕', 11, '扑尔敏，阿莫西林，头孢', '无', '/uploads/2020/05/26/df23a86b-eca1-4400-811c-1da1eedd4238.jpg', 1, '2020-05-27 18:08:30', '2020-05-27 18:08:30');
...
CREATE TABLE `permission`  (
  ...
  `p_des` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '权限描述',
...
-- ----------------------------
INSERT INTO `permission` VALUES (1, 'user:register:add', '客户预约挂号');
INSERT INTO `permission` VALUES (2, 'user:register:list', '客户查看预约列表');
...
CREATE TABLE `prescription`  (
  ...
  `p_sex` int(0) DEFAULT NULL,
  `p_age` int(0) DEFAULT NULL,
  `bed_no` int(0) DEFAULT NULL COMMENT '病床号',
  `nurse_id` int(0) DEFAULT NULL COMMENT '责任护士id',
  `create_time` datetime(0) DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0),
  `p_prescription` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT '处方',
  PRIMARY KEY (`p_id`) USING BTREE
...
CREATE TABLE `register`  (
  ...
  `d_id` int(0) DEFAULT NULL,
  `r_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '患者姓名',
  `r_sex` int(0) DEFAULT NULL COMMENT '性别 0.女，1.男',
  `r_type` int(0) DEFAULT NULL COMMENT '诊断类型，0检查/诊断，1治疗/手术，2复诊',
  `r_appointment_time` datetime(0) DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '预约时间',
  `r_patient_condition` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT '患者病情',
  `doc_id` int(0) DEFAULT NULL COMMENT '预约医生id',
  `r_state` int(0) DEFAULT NULL COMMENT '挂号状态 0已取消，1待付款，2已付款',
  `create_time` datetime(0) DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0),
  `update_time` datetime(0) DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0),
  `pay_time` datetime(0) DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '支付时间',
  `h_id` int(0) DEFAULT NULL COMMENT '预约医院id',
  `u_id` int(0) DEFAULT NULL COMMENT '用户id',
  `r_age` int(0) DEFAULT NULL COMMENT '患者年龄',
  `del_flag` int(0) DEFAULT NULL COMMENT '删除标识',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of register
-- ----------------------------
INSERT INTO `register` VALUES ('0d09d746d4ce4452b9c66886cbda3420', 1, '小亮', 1, 0, '2020-05-20 22:08:04', '发烧，咳嗽', 2, 1, '2020-05-20 22:08:04', '2020-05-20 22:08:04', '2020-05-20 22:08:04', 1, 6, 13, NULL);
INSERT INTO `register` VALUES ('18219086b0fd4f3da212a2e80cf217c3', 1, '小亮', 1, 0, '2020-05-20 22:07:58', '发烧，咳嗽', 2, 1, '2020-05-20 22:07:58', '2020-05-20 22:07:58', '2020-05-20 22:07:58', 1, 6, 13, NULL);
INSERT INTO `register` VALUES ('2837d65c4dac48f0933c3c7c469ec16d', 1, '小亮', 1, 0, '2020-05-20 22:08:27', '发烧，咳嗽', 2, 1, '2020-05-20 22:08:27', '2020-05-20 22:08:27', '2020-05-20 22:08:27', 1, 6, 13, NULL);
INSERT INTO `register` VALUES ('298ff23a7a1f48e991a86b9169c86197', 1, '小红', 0, 0, '2020-05-20 22:08:31', '发烧，咳嗽', 10, 1, '2020-05-20 22:08:31', '2020-05-20 22:08:31', '2020-05-20 22:08:31', 1, 6, 13, NULL);
INSERT INTO `register` VALUES ('3527a41de2d74b62b42816cefe1fa2fd', 1, '小红', 0, 0, '2020-05-20 22:08:09', '发烧，咳嗽', 11, 1, '2020-05-20 22:08:09', '2020-05-20 22:08:09', '2020-05-20 22:08:09', 1, 6, 13, NULL);
INSERT INTO `register` VALUES ('49dc9608d83c4689ade019b8279f2cc8', 1, '小丁', 1, 0, '2020-05-20 22:08:35', '发烧，咳嗽', 10, 1, '2020-05-20 22:08:35', '2020-05-20 22:08:35', '2020-05-20 22:08:35', 1, 4, 13, NULL);
INSERT INTO `register` VALUES ('4c8ec98db4474610895f9bc94e8a2ae9', 1, '小亮', 1, 0, '2020-05-20 22:08:37', '发烧，咳嗽', 2, 1, '2020-05-20 22:08:37', '2020-05-20 22:08:37', '2020-05-20 22:08:37', 1, 5, 13, NULL);
INSERT INTO `register` VALUES ('5870caed9bb542d0862e0e2c1b054c7e', 1, '小张', 1, 0, '2020-05-20 22:08:38', '发烧，咳嗽', 2, 1, '2020-05-20 22:08:38', '2020-05-20 22:08:38', '2020-05-20 22:08:38', 1, 4, 13, NULL);
INSERT INTO `register` VALUES ('6b42e470081440328da91e8766e05d2f', 1, '小红', 0, 0, '2020-05-20 22:08:41', '发烧，咳嗽', 11, 1, '2020-05-20 22:08:41', '2020-05-20 22:08:41', '2020-05-20 22:08:41', 1, 6, 13, NULL);
INSERT INTO `register` VALUES ('7095ac2dd5314c85aa1149fe96276a9f', 1, '小红', 0, 0, '2020-05-20 22:08:42', '发烧，咳嗽', 11, 1, '2020-05-20 22:08:42', '2020-05-20 22:08:42', '2020-05-20 22:08:42', 1, 6, 13, NULL);
INSERT INTO `register` VALUES ('7bd10aa2b32440dd863d93c06ce8653b', 1, '小亮', 1, 0, '2020-05-20 12:12:12', '发烧，咳嗽', 3, 1, '2020-05-23 09:28:27', '2020-05-23 09:28:27', NULL, 1, 6, 13, NULL);
INSERT INTO `register` VALUES ('8bcc17ca042d49e5b9fb664e974a6064', 1, '小亮', 1, 0, '2020-05-31 08:49:53', '发烧，咳嗽', 11, 2, '2020-05-31 08:49:53', '2020-05-31 08:49:53', '2020-05-31 08:49:53', 1, 6, 13, NULL);
INSERT INTO `register` VALUES ('9902f1a452ab4813aac71c117f9cc887', 1, '小亮', 1, 0, '2020-05-20 12:12:12', '发烧，咳嗽', 3, 1, '2020-05-23 09:31:54', '2020-05-23 09:31:54', NULL, 1, 6, 13, NULL);
INSERT INTO `register` VALUES ('c9ea9b01873543cc879a5ef9a0ff6f9e', 1, '小李', 1, 0, '2020-05-20 22:08:45', '发烧，咳嗽', 11, 1, '2020-05-20 22:08:45', '2020-05-20 22:08:45', '2020-05-20 22:08:45', 1, 4, 13, NULL);
INSERT INTO `register` VALUES ('cab43721f7a94e6cb8d924b56cf74a00', 1, '小红', 0, 0, '2020-05-20 22:08:46', '发烧，咳嗽', 2, 1, '2020-05-20 22:08:46', '2020-05-20 22:08:46', '2020-05-20 22:08:46', 1, 6, 13, NULL);
INSERT INTO `register` VALUES ('ce9eeaef381a408bb5b816e0e5f4de62', 1, '小张', 1, 0, '2020-05-20 22:08:48', '发烧，咳嗽', 2, 1, '2020-05-20 22:08:48', '2020-05-20 22:08:48', '2020-05-20 22:08:48', 1, 5, 13, NULL);
INSERT INTO `register` VALUES ('d63f1747c01e4db780d6d2575f1b93a9', 1, '小亮', 1, 0, '2020-05-20 22:08:49', '发烧，咳嗽', 2, 1, '2020-05-20 22:08:49', '2020-05-20 22:08:49', '2020-05-20 22:08:49', 1, 3, 13, NULL);
INSERT INTO `register` VALUES ('d7765c58dc2847228b147656a32494c2', 1, '小丁', 1, 0, '2020-05-20 22:08:50', '发烧，咳嗽', 2, 1, '2020-05-20 22:08:50', '2020-05-20 22:08:50', '2020-05-20 22:08:50', 1, 3, 13, NULL);
INSERT INTO `register` VALUES ('e4058f645a324a37b6958a7cc4cb9ff4', 1, '小红', 1, 0, '2020-05-20 22:08:54', '脸上长痘了', 10, 1, '2020-05-20 22:08:54', '2020-05-20 22:08:54', '2020-05-20 22:08:54', 1, 9, 13, NULL);
INSERT INTO `register` VALUES ('ed763971cf334ba296ad67105faa1a80', 1, '小亮', 1, 0, '2020-05-25 19:17:40', '发烧，咳嗽', 10, 1, '2020-05-25 19:17:40', '2020-05-25 19:17:40', '2020-05-25 19:17:40', 1, 10, 13, NULL);
INSERT INTO `register` VALUES ('f950059e26934ebda0a9db3d7aba6538', 1, '小李', 1, 0, '2020-05-25 19:17:29', '发烧，咳嗽', 10, 1, '2020-05-25 19:17:29', '2020-05-25 19:17:29', '2020-05-25 19:17:29', 1, 11, 13, 1);
INSERT INTO `register` VALUES ('fcd69b9b6e6a4b6a956bf10fc9c00f89', 1, '小明', 1, 0, '2020-05-30 12:31:40', '脸上长痘了', 10, 1, '2020-05-30 12:31:40', '2020-05-30 12:31:40', '2020-05-30 12:31:40', 1, 5, 13, 1);
...
CREATE TABLE `report`  (
  ...
  `r_name` varchar(0) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `r_sex` int(0) DEFAULT NULL,
  `r_age` int(0) DEFAULT NULL,
  `r_diagnosis_type` int(0) DEFAULT NULL COMMENT '诊断类型',
  `r_general_check` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '大体检查',
  `r_pathological_diagnosis` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '病理诊断',
  `r_immune` int(0) DEFAULT NULL COMMENT '免疫/组化',
  `r_result` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '结果',
  `r_mark` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT '备注',
  `r_physician` varchar(0) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '报告医师',
  `r_check_physician` varchar(0) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '核准医师',
  `r_time` datetime(0) DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '报告时间',
  `r_describe` varchar(0) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '描述文件',
  `r_division` int(0) DEFAULT NULL COMMENT '科别',
  `r_clinical_diagnosis` varchar(0) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '临床诊断',
  `d_id` int(0) DEFAULT NULL COMMENT '就诊科室id',
  `r_check_time` datetime(0) DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '检查时间',
  `r_inspection_item` varchar(0) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '检查项目',
  PRIMARY KEY (`r_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '病历报告' ROW_FORMAT = Dynamic;
...
CREATE TABLE `role`  (
  `r_id` int(0) NOT NULL,
  `r_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '角色名称',
  `r_des` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '描述',
  PRIMARY KEY (`r_id`) USING BTREE
...
INSERT INTO `role` VALUES (3, 'nurse', '护士');
INSERT INTO `role` VALUES (4, 'customer', '客户');
...
CREATE TABLE `role_permission`  (
  `id` int(0) NOT NULL,
  `p_id` int(0) DEFAULT NULL COMMENT '权限id',
  `r_id` int(0) DEFAULT NULL COMMENT '角色id',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `staff`  (
  ...
  `s_birthday` datetime(0) DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '出生日期',
  `s_sex` int(0) DEFAULT NULL,
  `id_role` int(0) DEFAULT NULL COMMENT '身份',
  `h_id` int(0) DEFAULT NULL COMMENT '就职医院',
  `s_address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '员工联系地址',
  `d_id` int(0) DEFAULT NULL COMMENT '所属科室id',
  `s_phone` int(0) DEFAULT NULL,
  `s_level` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '医院级别',
  `h_address` varchar(0) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '医院地址',
  `h_mployee_profile` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '员工简介',
  `h_work_experience` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT '工作经历',
  `h_related_document` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '相关证明',
  `create_time` datetime(0) DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0),
  `update_time` datetime(0) DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0),
...
CREATE TABLE `user`  (
  ...
  `sex` int(0) DEFAULT NULL COMMENT '性别 0.女，1.男',
  `id_num` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '身份证号',
  `email` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '电子邮箱',
  `address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '联系地址',
  `province_code` int(0) DEFAULT NULL COMMENT '省',
  `city_code` int(0) DEFAULT NULL COMMENT '市',
  `birthday` date DEFAULT NULL,
  `create_time` datetime(0) DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '创建日期',
  `update_time` datetime(0) DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '修改日期',
  `r_id` int(0) DEFAULT NULL COMMENT '角色id',
  `card_font_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '身份证正面',
  `card_back_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '身份证背面',
  `d_id` int(0) DEFAULT NULL COMMENT '部门id',
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'admin', '4280d89a5a03f812751f504cc10ee8a5', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2020-05-17 13:29:46', '2020-05-17 13:29:46', 1, NULL, NULL, NULL);
INSERT INTO `user` VALUES (2, 'abd', '4280d89a5a03f812751f504cc10ee8a5', '13338888997', '王医生', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2020-05-20 17:30:55', '2020-05-20 17:30:55', 2, NULL, NULL, 2);
INSERT INTO `user` VALUES (3, 'persion', '4280d89a5a03f812751f504cc10ee8a5', '13338888997', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2020-05-17 13:31:45', '2020-05-17 13:31:45', 4, NULL, NULL, NULL);
INSERT INTO `user` VALUES (4, 'persion2', '4280d89a5a03f812751f504cc10ee8a5', '13338888998', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2020-05-17 14:59:24', '2020-05-17 14:59:24', 4, NULL, NULL, NULL);
INSERT INTO `user` VALUES (5, 'persion7', '4280d89a5a03f812751f504cc10ee8a5', '13338888998', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2020-05-17 15:33:48', '2020-05-17 15:33:48', 4, NULL, NULL, NULL);
INSERT INTO `user` VALUES (6, 'persion9', '4280d89a5a03f812751f504cc10ee8a5', '13338888998', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2020-05-17 19:51:46', '2020-05-17 19:51:46', 4, NULL, NULL, NULL);
INSERT INTO `user` VALUES (7, 'persion19', '4280d89a5a03f812751f504cc10ee8a5', '13338888998', '张医生', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2020-05-20 19:07:36', '2020-05-20 19:07:36', 2, NULL, NULL, NULL);
INSERT INTO `user` VALUES (8, 'per', '4280d89a5a03f812751f504cc10ee8a5', '13338888955', 'Tony', 1, '410410200012127834', '22322132@qq.com', NULL, 120000, 120200, '2000-12-12', '2020-05-28 07:21:59', '2020-05-28 07:21:59', 3, NULL, NULL, NULL);
INSERT INTO `user` VALUES (9, 'perr', '4280d89a5a03f812751f504cc10ee8a5', '13338888955', 'Tony', 1, '410410200012121234', NULL, NULL, 120000, 120200, NULL, '2020-05-28 07:21:36', '2020-05-28 07:21:36', 3, NULL, NULL, NULL);
INSERT INTO `user` VALUES (10, 'doctor', '4280d89a5a03f812751f504cc10ee8a5', NULL, '刘医生', 0, NULL, NULL, '河南省郑州市管城回族区', NULL, NULL, NULL, '2020-05-25 18:54:17', '2020-05-25 18:54:17', 2, NULL, NULL, 1);
INSERT INTO `user` VALUES (11, 'qq', '4280d89a5a03f812751f504cc10ee8a5', NULL, '李医生', 1, NULL, NULL, '河南省郑州市管城回族区', NULL, NULL, NULL, '2020-05-25 18:57:26', '2020-05-25 18:57:26', 2, NULL, NULL, 4);
