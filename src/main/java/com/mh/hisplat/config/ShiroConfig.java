...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
        ...
        customFilterMap.put("authc",new CorsAuthenticationFilter());
        ...
        //filterChainDefinitionMap.put("/hospital/**", "anon");//Test
        filterChainDefinitionMap.put("/vcode", "anon");//获取验证码
        ...
        filterChainDefinitionMap.put("/returnUrl", "anon");
        // 所有url都必须认证通过才可以访问
